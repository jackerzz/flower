...
from .views.showlog import ShowlogView,ProcessManagement,StreamingHandler
...
handlers = [
    ...
    url(r"/showlog", ShowlogView, name='showlog'),
    url(r"/processinfo", ProcessManagement, name='processinfo'),
    url(r"/viewlog", StreamingHandler, name='viewlog'),
    # Worker API
